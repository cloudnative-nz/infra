...
launch=gpgsql
default-soa-content=ns.uk.cloudnative.coop hostmaster.cloudnative.coop 0 10800 3600 604800 3600
...
kubectl -n powerdns \
    ...
    --from-file=pdns.conf=secrets/pdns.conf \
    --from-file=_api.conf=secrets/_api.conf \
    --from-literal=api_key=${PDNS_API_KEY} \
    --from-literal=admin_user=${PDNS_ADMIN_USER} \
    --from-literal=admin_password=${PDNS_ADMIN_PASSWORD} \
    --from-literal=postgres-password=${PDNS_DB_PASSWORD} \
