...
#+begin_src shell
 kubectl -n longhorn get secret
#+end_src

#+RESULTS:
#+begin_example
NAME                   TYPE                DATA   AGE
longhorn-webhook-ca    kubernetes.io/tls   2      5d16h
longhorn-webhook-tls   kubernetes.io/tls   2      5d16h
#+end_example
...
kubectl -n longhorn \
    ...
    --from-literal=AWS_ACCESS_ACCESS_KEY="$MINIO_ROOT_PASSWORD" \
